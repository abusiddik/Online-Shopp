...
public class ShopUser  implements java.io.Serializable {
    ...
    public ShopUser(UserRole userRole, String userName, String password, String email, Date regDate, String contactNum) {
    ...
    public ShopUser(UserRole userRole, String userName, String password, String email, Date regDate, String contactNum, Set proOrders) {
       this.userRole = userRole;
       this.userName = userName;
       this.password = password;
       this.email = email;
